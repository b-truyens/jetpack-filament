<div class="inline-flex fixed top-0 right-0 p-6 text-right z-10" role="group">
    @if (Route::has('login'))
        @auth
            ...
            <a href="{{ url('/admin') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                Admin
            </a>
        @else
